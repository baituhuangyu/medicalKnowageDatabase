...
tf.flags.DEFINE_integer(name="vocab_size", default=6020, help="vocab num")
...
tf.flags.DEFINE_string(name="tag_char", default="O,B-KEY,I-KEY,E-KEY", help="used in dataset, split by ,")

tf.flags.DEFINE_string(name="saved_model", default="ner_model", help="saved train model path, default ./ner_model")
